...
public class KafkaApplication {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*
         * Sending a Hello World message to topic 'World'.
        ...
        String[] partitions = {"1","2","3","4","5"};
        for (int i = 0; i < 5; i++) {
            producer.sendMessageToPartition("Hello To Partitioned Topic!", partitions[i]);
        }
    ...
    public static class MessageProducer {
        ...
        public void sendMessage(String message) {
            kafkaTemplate.send(partitionedTopicName, message);
        }
    ...
    public static class MessageListener {
        ...
        @KafkaListener(topicPartitions = @TopicPartition(topic = "partitioned", partitions = { "0", "3" }))
